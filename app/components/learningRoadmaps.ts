...
export const learningTracks: LearningTrack[] = [
  ...
  },
  {
    ...
    shortLabel: "Git",
    description:
      "Praktyczna sciezka Gita: od lokalnych commitow i branchy po rebase, konflikty, pull requesty i bezpieczna wspolprace w zespole.",
    icon: GitBranch,
    accent: "text-rose-300",
    border: "border-rose-500/20",
    sourceUrl: "https://roadmap.sh/git-github",
    sourceLabel: "roadmap.sh/git-github",
    resources: [
      {
        id: "git-roadmap",
        title: "Mapa Gita i GitHuba",
        description: "Porzadkuje core Git, GitHub workflow, PR-y, branching i praktyki zespolowe.",
      ...
      },
      {
        id: "pro-git-book",
        title: "Pro Git",
        description: "Darmowa ksiazka od podstaw po zaawansowane rozdzialy o internals i narzedziach.",
      ...
      },
      {
        id: "git-reference",
        title: "Git reference",
        description: "Oficjalna referencja komend, gdy chcesz sprawdzic opcje bez zgadywania.",
      ...
      },
      {
        id: "github-flow",
        title: "GitHub Flow",
        description: "Krotki model pracy z branchami, pull requestami i review w codziennym projekcie.",
      ...
      {
        id: "atlassian-git",
        title: "Branching i rebase w praktyce",
        description: "Przystepne materialy o workflow, merge, rebase i rozwiazywaniu konfliktow.",
    ...
    milestones: [
      {
        ...
        summary: "Mentalny model repozytorium, historii i lokalnej pracy bez przypadkowego chaosu.",
        topics: [
          { id: "repository-model", label: "Working tree, staging area, commits i historia zmian" },
          { id: "basic-commands", label: "init, clone, status, add, commit, log i diff" },
          { id: "ignore-files", label: ".gitignore, pliki sledzone i usuwanie rzeczy z indeksu" },
          { id: "commit-quality", label: "Male commity, dobra tresc commita i atomowe zmiany" },
        ],
      },
      {
        id: "branches-merging",
        title: "Branches and Merging",
        summary: "Codzienna praca na branchach i laczenie zmian bez utraty kontekstu.",
        topics: [
          { id: "branching", label: "branch, switch, checkout i nazywanie branchy" },
          { id: "merge", label: "merge, fast-forward i merge commit" },
          { id: "conflicts", label: "Rozwiazywanie konfliktow i czytanie markerow konfliktu" },
          { id: "restore-reset", label: "restore, reset i bezpieczne cofanie lokalnych zmian" },
        ],
      },
      {
        id: "remote-collaboration",
        title: "Remote Collaboration",
        summary: "Praca z GitHubem albo innym remote tak, zeby zespol widzial czytelny przeplyw zmian.",
        topics: [
          { id: "remotes", label: "remote, origin, fetch, pull i push" },
          { id: "tracking", label: "Upstream branches i synchronizacja lokalnej pracy" },
          { id: "pull-requests", label: "Pull requesty, review i iterowanie po feedbacku" },
          { id: "forks", label: "Fork workflow i praca z cudzym repozytorium" },
        ],
      },
      {
        id: "history-tools",
        title: "History and Repair Tools",
        summary: "Narzedzia do porzadkowania historii, gdy trzeba poprawic branch przed oddaniem zmian.",
        topics: [
          { id: "rebase", label: "rebase, interactive rebase i kiedy go nie robic" },
          { id: "stash", label: "stash, pop, apply i tymczasowe odkladanie pracy" },
          { id: "cherry-pick", label: "cherry-pick i przenoszenie pojedynczych commitow" },
          { id: "reflog", label: "reflog jako siatka bezpieczenstwa po pomylkach" },
        ],
      },
      {
        id: "team-practices",
        title: "Team Practices",
        summary: "Praktyki, ktore robia z Gita narzedzie wspolpracy, a nie zrodlo tarcia.",
        topics: [
          { id: "branch-strategy", label: "GitHub Flow, trunk-based development i release branches" },
          { id: "code-review", label: "Reviewable PR-y, zakres zmian i komunikacja w opisie" },
          { id: "tags-releases", label: "Tagi, wersje i release notes" },
          { id: "hooks-ci", label: "Hooks, CI checks i ochrona glownej galezi" },
        ],
      },
    ],
  },
